...
class Options():
    def __init__(self):
        ...
        # model and dataset 
        parser.add_argument('--n_class', type=int, default=5, help='classification classes')
        parser.add_argument('--data_path', type=str, default='/home/roo/Desktop/Bui/MED7004/UBC-OCEAN', 
